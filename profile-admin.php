        ...
        <div class="profil-admin-box-creation-compte" id="profil-admin-box-creation-compte">
            ...
            <div class="first-ligne-info">
                <div class="infos-perso">
                    ...
                    <input type="text" class="input-profil-utilisateur" id="nom-creation-admin" name="nom-creation-admin" value="" required>
                </div>
                <div class="infos-perso">
                    <label for="prenom-creation-admin">Prénom :</label>
                    <input type="text" class="input-profil-utilisateur" id="prenom-creation-admin" name="prenom-creation-admin" value="" required>
                </div>
            </div>
            <div class="second-ligne-info">
                <div class="infos-perso">
                    <label for="email-creation-admin">Email :</label>
                    <input type="email" class="input-profil-utilisateur" id="email-creation-admin" name="email-creation-admin" value="" required>
                </div>
                <div class="infos-perso">
            ...
            <div class="second-ligne-info">
                ...
                <div class="infos-perso">
                    ...
                    <input type="text" class="input-profil-utilisateur" id="ville-creation-admin" name="ville-creation-admin" value="" required>
                </div>
            </div>
