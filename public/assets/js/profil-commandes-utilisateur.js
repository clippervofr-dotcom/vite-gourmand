...
async function chargerCommandesUser() {
    const reponse = await fetch('/commandes/mes-commandes.php');
...
if (annulationModal && annulationCheckbox && annulationConfirm && annulationClose) {
    ...
    function changementStatutAnnuler() {
        ...
        const motifAnnulation = document.querySelector('#annulation-utilisateur-content-textarea');
        ...
        return fetch('/commandes/commandes-utilisateur-annuler.php', {
            method: 'POST',
            body: donnees
        });
    }
...
if (avisModalClose && avisBtnConfirmer && avisModal) {
    ...
    avisModal.addEventListener('click', async function (event) {
        ...
        const reponse = await fetch('/avis/avis-post.php', {
            method: 'POST',
            body: donnees
        });
