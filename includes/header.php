    ...
    <nav>
        ...
        <div class="nav-links">
            <div class="nav-links-menus" id="nav-links-menus">
                ...
                <?php if (htmlspecialchars(isset($_SESSION['utilisateur'])) && $_SESSION['utilisateur']['role_id'] == 3): ?>
                    <div class="nav-utilisateur">
                        <div class="profil-box">
                            ...
                            <div class="dropdown-profil">
                                <a href="profile-admin.php" class="animated-button" id="btn-admin-administration-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                                ...
                                <a href="deconnexion.php" class="animated-button" id="btn-admin-deconnexion-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                ...
                <?php elseif (htmlspecialchars(isset($_SESSION['utilisateur'])) && $_SESSION['utilisateur']['role_id'] == 2): ?>
                    <div class="nav-utilisateur">
                        <div class="profil-box">
                            <button class="bouton-profil" id="btn-profil">
                                <img src="assets/images/utilisateur.png" class="profil-logo" alt="Mon profil">
                            ...
                            <div class="dropdown-profil">
                                <a href="profile-employe.php" class="animated-button" id="btn-employe-commandes-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                                ...
                                <a href="deconnexion.php" class="animated-button" id="btn-employe-deconnexion-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                ...
                <?php elseif (htmlspecialchars(isset($_SESSION['utilisateur']))): ?>
                    ...
                    <div class="nav-utilisateur">
                        ...
                        <div class="profil-box">
                            ...
                            <div class="dropdown-profil">
                                <a href="profile-user.php" class="animated-button" id="btn-utilisateur-compte-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                                ...
                                <a href="mon-panier.php" class="animated-button" id="btn-utilisateur-panier-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
                                ...
                                <a href="deconnexion.php" class="animated-button" id="btn-utilisateur-deconnexion-panel">
                                    <svg viewBox="0 0 24 24" class="arr-2" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                                d="M16.1716 10.9999L10.8076 5.63589L12.2218 4.22168L20 11.9999L12.2218 19.778L10.8076 18.3638L16.1716 12.9999H4V10.9999H16.1716Z"
                                        ></path>
